                                        ...
                                        <div class="details-image-1 ratio_asos">
                                            <div>
                                                <img src="{{ asset('assets/images/fashion/product/front/' . $product->image) }}"
                                                    data-zoom-image="{{ asset('assets/images/fashion/product/front/' . $product->image) }}"
                                ...
                                <div class="cloth-details-size">
                                    ...
                                    <h3 class="price-detail">
                                        @if ($product->sale_price)
                                            ...
                                            <del>${{ $product->sale_price }}.00</del><span>{{ round((($product->regular_price - $product->sale_price) / $product->regular_price) * 100) }}
                                                % off</span>
                                        @else
                                            ${{ $product->regular_price }}
                                        @endif
                                    ...
                                    <div class="mt-2 mt-md-3 border-product">
                                        <h6 class="product-title hurry-title d-block">
                                            @if ($product->stock_status == 'instock')
                                                <span style="color: green">InStock --</span> Hurry Up! Left
                                                <span>{{ $product->quantity }}</span> in
                                                stock
                                            @else
                            ...
                            <div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="{{ route('shop.product.detail', ['slug' => $bproduct->slug]) }}">
                                        ...
                                        <div class="back">
                                            <a href="{{ route('shop.product.detail', ['slug' => $bproduct->slug]) }}">
                                                <img src="{{ asset('http://localhost:8000/assets/images/fashion/product/back/' . $bproduct->image) }}"
                                                    class="bg-img blur-up lazyload" alt="">
                                            </a>
                                        </div>
                                        <div class="cart-wrap">
                                    ...
                                    <div class="product-details">
                                        <div class="rating-details">
                                            <span class="font-light grid-content">{{ $bproduct->name }}</span>
                                        ...
                                        <div class="main-price">
                                            ...
                                            <div class="listing-content">
                                                <h5>{{ $bproduct->category->name }}</h5>

                                                <p>{{ $bproduct->short_description }}</p>
                                            </div>
                                            <h3 class="theme-color">
                                                @if ($bproduct->sale_price > 0)
                                                    {{ $bproduct->sale_price }}
                                                @else
                                                    {{ $bproduct->regular_price }}
                                                @endif
                                            </h3>
